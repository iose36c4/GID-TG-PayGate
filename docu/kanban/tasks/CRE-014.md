...
# [[CRE-014]] Configuración MercadoPago Argentina: SDK, Credenciales, Pagos Efectivo, Cuotas Sin Interés

## Descripción
Implementar configuración específica de MercadoPago para Argentina: SDK oficial, credenciales (Client ID/Secret, Access Token, Public Key), métodos de pago en efectivo (PagoFácil, Rapipago, Provincia NET), cuotas sin interés, webhooks IPN, testing sandbox.

## Código de Ejemplo
```php
// app/Domains/Creadores/Services/MercadoPagoArgentinaService.php
...
class MercadoPagoArgentinaService
{
    ...
    public function createCheckoutPreference(array $data): array
    {
        ...
        $preference = [
            ...
            'back_urls' => [
                'success' => route('checkout.success', $data['channel_slug']),
                'failure' => route('checkout.failure', $data['channel_slug']),
                'pending' => route('checkout.pending', $data['channel_slug']),
            ],
            'auto_return' => 'approved',
            'notification_url' => route('webhooks.mercadopago', $data['channel_id']),
            ...
            // Cuotas sin interés (promociones bancarias)
            'installments' => [
                'default_installments' => 1,
    ...
    private function handlePaymentNotification(array $payment): void
    {
        ...
        // Buscar suscripción/pedido por external_reference
...
```php
// app/Services/MercadoPagoWebhookController.php
namespace App\Http\Controllers;

use App\Services\MercadoPagoArgentinaService;

class MercadoPagoWebhookController extends Controller
{
    public function __construct(protected MercadoPagoArgentinaService $mpService) {}
...
- [[PUB-014]] MercadoPago Argentina (PUB)

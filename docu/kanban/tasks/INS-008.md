...
# [[INS-008]] Paso 2.6: Configuración Fiscal Argentina (IVA, Ganancias, IIBB, AFIP CAE, Factura A/B/C)
        ...
        <div class="card card--elevated p-8">
            <div class="text-center mb-8">
                <div class="w-16 h-16 mx-auto mb-4 bg-accent-100 dark:bg-accent-900/30 rounded-full flex items-center justify-center">
                    <x-icon name="file-text" class="w-8 h-8 text-accent-primary" />
                </div>
...
```php
// app/Http/Controllers/InstallController.php - saveFiscalConfig

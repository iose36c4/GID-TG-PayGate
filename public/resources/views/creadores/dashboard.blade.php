...
<div class="container mx-auto px-4 py-8">
    ...
    @if(!auth()->user()->hasCompletedOnboarding())
        <div class="mb-8 p-6 bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-xl">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('creador.onboarding.index') }}" class="bg-primary-600 hover:bg-primary-700 text-white font-medium py-3 px-6 rounded-lg transition-colors">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="{{ route('creador.channels.create') }}" class="bg-primary-600 hover:bg-primary-700 text-white font-medium py-2 px-4 rounded-lg transition-colors text-sm">
        ...
        @if(auth()->user()->channels->isEmpty())
            <div class="text-center py-12">
                ...
                <a href="{{ route('creador.channels.create') }}" class="bg-primary-600 hover:bg-primary-700 text-white font-medium py-2 px-6 rounded-lg transition-colors inline-block">

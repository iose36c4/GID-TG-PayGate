...
<div class="container mx-auto px-4 py-8 max-w-2xl">
    <div class="mb-8">
        ...
        <form action="{{ route('creador.onboarding.step4.store', $channel) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex justify-between gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                <a href="{{ route('creador.onboarding.step3', $channel) }}" class="bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-900 dark:text-white font-medium py-3 px-6 rounded-lg transition-colors inline-flex items-center gap-2">
